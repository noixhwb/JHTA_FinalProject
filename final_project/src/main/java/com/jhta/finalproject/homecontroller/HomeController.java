...
public class HomeController {
	...
	@Autowired private DealService d_service;
	...
	public String home(Model model) {
		...
		/*
		 * List<DealVo> deallist = service.dealList(); List<Goods_ImageVo> dealimglist =
		 * new ArrayList<Goods_ImageVo>(); for(DealVo li:deallist) { List<Goods_ImageVo>
		 * img = d_service.selectImg(li.getT_num()); dealimglist.add(img.get); }

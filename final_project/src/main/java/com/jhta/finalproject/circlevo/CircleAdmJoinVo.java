...
public class CircleAdmJoinVo {
	...
	private String m_id; //게시요청자 아이디
	private String m_name; //게시요청자 이름
	private String m_nickname; //게시요청자 닉네임
	private String m_phone; //게시요청자 폰번호
	private String m_email; //게시요청자 이메일
	private String m_dept; //게시요청자 학과
}

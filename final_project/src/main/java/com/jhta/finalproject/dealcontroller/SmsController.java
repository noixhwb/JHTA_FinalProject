...
public class SmsController {
	...
	public String sendFrom(Model model, String action, String msg, String rphone, String sphone1, String sphone2,
			String sphone3, String rdate, String rtime, String smsType, String subject, String testflag,
		...
		try {
			...
			if (action.equals("go")) {
				String sms_url = "https://sslsms.cafe24.com/sms_sender.php";
				String user_id = base64Encode("lamgul");
				String secure = base64Encode("6f15e3a9a71b3a4af0b5214088b8401d");
				...
				smsType = base64Encode(nullcheck(smsType, ""));

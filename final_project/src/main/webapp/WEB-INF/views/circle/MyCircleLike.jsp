    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse"
    	...
    	<div class="collapse navbar-collapse" id="navbarNavDropdown">
    		<ul class="nav nav-tabs navbar-nav">
		        <li class="nav-item">
		        	<a class="nav-link" aria-current="page" href="${ cp }/circle/MyCircleList">신청한 동아리</a>
		        </li>
		        <li class="nav-item">
    	...
    	<ul class="nav navbar-nav justify-content-end">
    		<!-- 동아리 검색 -->
    		<li>
				<form action="${ cp }/circle/MyCircleLike"  
			...
			<c:otherwise>
				<div class="col-8 offset-2 mt-4 mb-5 justify-content-center">
					<div class="card shadow text-center" style="height: 110px;">
						<br><br>
						<h6 class="m-0 font-weight-bold text-danger justify-content-center">찜한 동아리가 없습니다</h6>
					</div>
				</div>
			</c:otherwise>
			</c:choose>
